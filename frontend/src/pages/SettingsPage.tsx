...
export function SettingsPage({ onNavigate }: SettingsPageProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!formData.profile || !formData.region) {
      handleAPIError(
        new APIError("Profile and region are required"),
        undefined,
        "Validation Error",
      );
      return;
    ...
    try {
      ...
      showSuccess(
        ...
        "Configuration saved and connection established",
      );
    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-6 text-sm text-gray-600">
          <p>
            <strong>Note:</strong> Configuration is stored in memory only and
            will be lost when the application restarts.
          </p>
        </div>
      </div>
    </div>
